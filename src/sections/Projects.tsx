        ...
        <section className="bg-[#1B1820] pb-2 rounded-sm text-white">
            ...
            {loading && (
                <ProjectStateNotice
                    ...
                    message="Fetching your latest project data."
                />
            )}
            ...
            {!loading && !error && projects.length === 0 && (
                <ProjectStateNotice
                    ...
                    message="Add a project source or try again later."
                    tone="empty"
                />
            )}
            ...
            <div className="flex justify-center md:justify-end pr-0 md:pr-4">
                <button
                    ...
                    className="hover:text-[#5DAEDE] disabled:cursor-not-allowed disabled:opacity-50"
